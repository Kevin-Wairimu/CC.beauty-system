    ...
    <div className="bg-[#1a1a1a] min-h-screen text-white py-20 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl font-serif font-bold uppercase tracking-widest text-gold mb-4 text-shadow-lg">Book Your Session</h1>
        ...
        <motion.form 
          ...
          className="glass-panel p-8 md:p-16 shadow-2xl relative overflow-hidden"
        >
          <div className="absolute top-0 right-0 w-64 h-64 bg-gold/10 blur-[100px] rounded-full -mr-32 -mt-32"></div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-10">
            <div className="relative group">
              <label className="block text-xs font-bold uppercase tracking-[0.2em] text-gold mb-3 flex items-center gap-2">
              ...
              <input 
                ...
                className="w-full bg-black/40 border-b border-white/10 group-focus-within:border-gold px-4 py-4 outline-none transition-all placeholder:text-gray-600 text-white text-lg" 
              />
            </div>
            <div className="relative group">
              <label className="block text-xs font-bold uppercase tracking-[0.2em] text-gold mb-3 flex items-center gap-2">
          ...
          <motion.button 
            ...
            className="w-full btn-gold text-xl py-6 uppercase tracking-[0.4em] disabled:opacity-50 shadow-gold/20 shadow-2xl rounded-none"
          >
