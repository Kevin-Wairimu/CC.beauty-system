...
const Admin = () => {
  ...
  const handleComplete = async (appointmentId, price) => {
    const finalPrice = window.prompt(
      "Enter final amount paid (KSh):",
      price || "0",
    );
              ...
              <div className="space-y-6">
                {appointments.length === 0 ? (
                  ...
                  appointments.map((app) => (
                    <div
                      key={app._id}
                      className={`glass-panel p-8 flex flex-col xl:flex-row justify-between gap-8 group hover:border-gold/40 transition-all duration-700 bg-[#121212] ${app.status === "completed" ? "opacity-40 border-white/5" : "border-white/10"}`}
                    >
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-10 flex-grow">
                        ...
                        <div className="space-y-2">
                          <span className="text-[9px] uppercase tracking-widest text-gold font-black flex items-center gap-2">
                            <PieChart className="h-3 w-3" /> Service Selection
                          </span>
                      ...
                      <div className="flex items-center gap-4 border-t xl:border-t-0 xl:border-l border-white/5 pt-6 xl:pt-0 xl:pl-10">
                        <div className="flex flex-wrap gap-3 w-full sm:w-auto">
                          ...
                          {app.status === "approved" && (
                            <button
                              onClick={() => handleComplete(app._id, app.price)}
                  ...
                  <div className="glass-panel p-10 bg-[#121212] border-white/10">
                    ...
                    <div className="grid grid-cols-2 gap-6">
                      <div className="p-6 bg-black/40 border border-white/5">
                        <p className="text-[9px] text-gray-500 font-black uppercase mb-2">
                          Total Bookings
                        </p>
                        ...
                        {appointments.map((app) => (
                          ...
                          >
                            ...
                            <td className="p-6 text-right font-serif font-bold">
                              KSh {parseFloat(app.price || 0).toLocaleString()}
                            </td>
                          </tr>
                        ))}
                      </tbody>
